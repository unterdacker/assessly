 ...
 *
 * ════════════════════════════════════════════════════════════════════════════
 * AVRA Forensic Audit Log — Hash-Chain Verifier
 * ════════════════════════════════════════════════════════════════════════════
 *
 * PURPOSE
 ...
 * lib/audit-sanitize.ts and is specified by the AVRA Audit Log Specification
 * (see file header).
 *
...
async function main(): Promise<void> {
  ...
  emit(DIVIDER);
  emit("  AVRA Forensic Audit Log — Hash-Chain Verification Report");
