...
| Intent | How |
|--------|-----|
| Inspect workspace / diffs | read, grep, glob, git diff via bash |
| Deep isolated exploration | task subagent for readonly exploration |
| Style guide & live docs | websearch for stack and patterns |
| External vendor context | websearch or webfetch |
| Project memory / standards | .opencode/agents, .impeccable.md, PRODUCT.md, DESIGN.md |
