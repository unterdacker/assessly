...
description: Security and privacy specialist. Analyzes code and plans for vulnerabilities, validates architectural decisions, ensures compliance with OWASP/NIST/GDPR-style expectations.
readonly: true
---
