      ...
      <div className="w-full max-w-sm rounded-xl border bg-card text-card-foreground shadow-sm">
        <div className="flex flex-col space-y-1.5 p-6 pb-4">
          ...
          <p className="text-xs font-semibold uppercase tracking-wider text-indigo-600">
            {t("pageSubtitle", { defaultMessage: "Create a password to activate your Venshield account" })}
          </p>
          <h1 className="text-2xl font-semibold tracking-tight text-foreground">
            {t("pageTitle", { defaultMessage: "Set Up Your Account" })}
          </h1>
        ...
        <div className="p-6 pt-0">
          <Suspense fallback={<div className="h-64 animate-pulse rounded-md bg-muted" />}>
            <AuthAcceptInviteForm token={token} />
          </Suspense>
        </div>
      </div>
    </main>
