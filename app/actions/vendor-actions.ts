...
export async function createVendorAction(
  ...
  try {
    ...
    const vendorSnapshot = createdVendorSnapshot as { id: string; serviceType: string; createdAt: Date } | null;
    if (vendorSnapshot) {
...
export async function generateVendorAccessCodeAction(
  ...
  try {
    ...
    await prisma.$transaction(async (tx) => {
      ...
      console.log(
        `[TEMPLATE] You have been invited to an assessment. Visit venshield.app/portal and use your temporary access code: ${accessCode}.`,
      );
