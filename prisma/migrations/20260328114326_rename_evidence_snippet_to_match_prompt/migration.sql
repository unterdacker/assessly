/*
  ...
  - You are about to drop the column `evidenceUrl` on the `AssessmentAnswer` table. All the data in the column will be lost.
...
INSERT INTO "new_AssessmentAnswer" ("assessmentId", "createdAt", "createdBy", "findings", "id", "questionId", "status", "updatedAt") SELECT "assessmentId", "createdAt", "createdBy", "findings", "id", "questionId", "status", "updatedAt" FROM "AssessmentAnswer";
