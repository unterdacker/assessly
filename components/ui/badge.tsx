...
const badgeVariants = cva(
  "inline-flex items-center rounded-[var(--radius-badge)] px-2 py-0.5 text-xs font-semibold uppercase tracking-wider transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        default:
