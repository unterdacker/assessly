...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn(
      "border-b border-slate-200 bg-slate-50 dark:border-slate-800 dark:bg-slate-900/70",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-10 px-4 text-left align-middle text-xs font-semibold text-foreground/75",
      className,
    )}
    {...props}
  />
